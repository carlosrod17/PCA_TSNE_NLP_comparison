...
fig_to_tfm = (
    ...
    .update_layout(
        ...
        xaxis2 = dict(title = "DBSCAN", tickvals = [0, 0.5, 1], showticklabels=False),
        xaxis3 = dict(title = "Real", tickvals = [0, 0.5, 1], showticklabels=False),
        xaxis4 = dict(title = "DBSCAN", tickvals = [0, 0.5, 1], showticklabels=False),
        xaxis5 = dict(title = "Real", tickvals = [0, 0.5, 1], showticklabels=False),
        xaxis6 = dict(title = "DBSCAN", tickvals = [0, 0.5, 1], showticklabels=False),
...
fig_to_tfm.write_image(os.path.join(FIGURES_PATH, "3_3_scatterplot.png"))
