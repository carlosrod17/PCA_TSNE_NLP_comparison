...
topic1 <- c('Ucrania guerra', 'Ucrania Rusia', 'Putin guerra', 'Putin nuclear',
            ...
            'movilización Rusia','avance Ucrania')
...
topic7 <- c('LGTBI SEPE', 'Ley trans', 'PSOE trans', 'PODEMOS trans',
            'ministerio igualdad', 'niños trans', 'médicos trans',
            'trans deporte femenino', 'hormonación trans', 'registro trans',
            'Irene Montero trans', '"lenguaje inclusivo" Irene Montero',
            '"lenguaje inclusivo" Podemos', '"cambio de sexo"',
...
ntweets = c(600,1000,500,1200,1200,
