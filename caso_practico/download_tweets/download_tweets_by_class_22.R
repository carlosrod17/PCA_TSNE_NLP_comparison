...
topic5 <- c('inmigración España', 'menas', 'Melilla BBC',
            ...
            '"inmigración marroquí"', 'imágenes tragedia Melilla',
            'videos Melilla')
...
topic7 <- c('LGTBI SEPE', 'Ley trans', 'ley "sí es sí"', 'justicia machista',
            ...
            '"ideología de género"', '"hazte oir"', 'rebajas pena "sí es sí"')
...
topic10 <- c('delito sedición', 'independentismo', 'líderes independentistas',
             ...
             'Cataluña 2017', 'Puigdemont', 'Junqueras', 'delito malversación',
...
for (i in 1:length(topics)) {
  ...
  path <- paste("0_BBDD/1_TWEETS_RAW_BY_CLUSTER/tweets_",as.character(i),".csv",sep="")
